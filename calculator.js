...
let operación = prompt("1: sumar, 2: restar, 3: dividir, 4: multiplicar")
...
if (operación == "1"){
    ...
    alert("no se ha encuentrado la operación, recuerde debe insertar el numero correspondiente a la operación")
}